...
int funcA(int t[], int p[], int tam, int identificador){
...
int main(){
    ...
    int soma = 0;
    int j;
    //inicializar vetor com todas as casa com valor 0
	...
	//ler cestas time da casa
    for(j=0; j<20; j++){
    	printf("Digite os pontos que o time da casa fez na cesta %d de 20 cestas: \n", j+1);
        scanf("%d", &t[j]);
    }
    soma = funcA(t, p, tam, t1);
    printf("Ao final de 20 arremessos o time da casa fez: %d\n", soma);
    
    //ler cestas time visitante
    for(j=0; j<20; j++){
    	printf("Digite os pontos que o time visitante fez na cesta %d de 20 cestas: \n", j+1);
        scanf("%d", &p[j]);
    }
    soma = funcA(t, p, tam, t2);
    printf("Ao final de 20 arremessos o time visitante fez: %d\n", soma);
